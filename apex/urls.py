...
urlpatterns = [
    ...
    # For raw material
    path('Raw-Material-Stock/',Raw_Material,name='raw_material'),
    ...
    path('Finished-Material-Stock/',Finished_Material,name='finished_material'),
    ...
    path('finished_material_graph',finished_material_graph,name='finished_material_graph'),

    # For unfinished material
    path('Un-Finished-Material-Stock/',UnFinished_Material,name='unfinished_material'),
    ...
    path('unfinished_material_graph',unfinished_material_graph,name='unfinished_material_graph'),

    # For essential items
    path('Essential-Item-Stock/',Essential_Material,name='essential_material'),
    ...
    path('essential_material_graph',essential_material_graph,name='essential_material_graph'),
